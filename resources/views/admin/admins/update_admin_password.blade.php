              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="all-form-element-inner">
                    <form action="{{ route('adminUpdatePassword') }}" method="post">@csrf
                      ...
                      <div class="form-group-inner">
                        <div class="row">
                          ...
                          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="password" name="admin_current_password" id="admin_current_password" class="form-control" />
                      ...
                      <div class="form-group-inner">
                        <div class="row">
                          ...
                          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="password" id="admin_new_password" name="admin_new_password" class="form-control password_errors" />
                          </div>
                        </div>
                      </div>
                      <div class="form-group-inner">
                        <div class="row">
                          ...
                          <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                            <input type="password" id="admin_confirm_pwd" name="admin_confirm_pwd" class="form-control password_errors" />
                          </div>
                        </div>
                      </div>
